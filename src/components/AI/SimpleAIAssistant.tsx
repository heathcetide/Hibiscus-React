  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999]" style={{ zIndex: 9999 }}>
      ...
      <motion.button
        ...
        className={`relative w-16 h-16 rounded-full shadow-2xl transition-all duration-300 border-2 ${
          isActive 
            ? 'bg-gradient-to-r from-purple-500 to-pink-500 border-purple-600' 
            : 'bg-gradient-to-r from-blue-500 to-cyan-500 border-blue-600 hover:from-blue-600 hover:to-cyan-600 hover:border-blue-700'
        }`}
      ...
      >
        ...
        >
          <Brain className="w-8 h-8 text-white mx-auto drop-shadow-lg" />
        </motion.div>
      ...
      <AnimatePresence>
        {isActive && (
          <motion.div
            ...
            style={{ zIndex: 9998 }}
          >
            <Card className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-2 border-gray-200 dark:border-gray-700 shadow-2xl">
              <div className="p-6">
                {/* 头部 */}
                      ...
                      <motion.button
                        ...
                        className={`p-3 rounded-lg text-left transition-all border ${
                          selectedType === type.type
                            ? 'bg-gradient-to-r ' + type.color + ' text-white shadow-lg border-transparent'
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full h-24 p-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white"
                  />
                </div>
                  ...
                  <AnimatePresence>
                    {responses.map((response) => (
                      <motion.div
                        ...
                        className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border-2 border-blue-200 dark:border-blue-800"
                      >
